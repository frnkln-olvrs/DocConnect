...
<body>
  ...
  <section id="campus" class="page-container">
    <div class="d-flex justify-content-center position-relative my-3">
      ...
      <a href="./admin.add_campus" class="btn btn-success text-white position-absolute end-0">Add Campus</a>
    </div>

    <div class="row row-cols-1 row-cols-md-2 mx-1 mx-md-5">
      <div class="col p-0 mb-3">
        <a href="./admin.view_campus" class="card mx-3 mb-sm-3 rounded-3 shadow-sm h-100">
